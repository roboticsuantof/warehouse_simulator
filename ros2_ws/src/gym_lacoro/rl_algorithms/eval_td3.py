...
from stable_baselines3 import TD3
from stable_baselines3.td3.policies import CnnPolicy, MultiInputPolicy
...
# Algorithm
algorithm, policy = TD3, MultiInputPolicy
policy_args = None

# Evaluation loop

agent_path = "/home/kishouandrea/lacoro-reto/ros2_ws/src/gym_lacoro/rl_algorithms/models/TD3/warehouse_final"
...
for mission in datos_mision["scenarios"]:
    ...
    evaluate_agent(action_selection, env, 1, 1000, mission["start"], mission["goal"])
    break
